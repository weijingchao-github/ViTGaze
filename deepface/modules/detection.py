...
def deepface_face_detector_model_init(detector_backend: str):
    return DetectorWrapper.deepface_face_detector_model(detector_backend)


def deepface_face_detect(face_detector, img):
    return face_detector.detect_faces(img)
